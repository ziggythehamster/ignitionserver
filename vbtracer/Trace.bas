...
'// This lies outside of the conditional compile.
'// That's because we still want to spew Bugs to NOTICE even if debugging is off.
Public Sub Bug(Message As String)
Trace Message
SendSvrMsg Message & " Please file a bug report at <http://bugs.ignition-project.com/>."
End Sub
